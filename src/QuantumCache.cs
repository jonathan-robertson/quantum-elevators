namespace QuantumElevators
{
    ...
    {
        private static readonly ModLog<QuantumCache> _log = new ModLog<QuantumCache>();
        ...
        {
            _log.Debug($"OnBlockChanged => pos:{pos}, bvOld:{bvOld}, densOld:{densOld}, texOld:{texOld}, bvNew:{bvNew}");
        ...
        {
            _log.Debug($"OnBlockDestroyed => {blockValue.Block.GetBlockName()} was just destroyed at {pos}");
